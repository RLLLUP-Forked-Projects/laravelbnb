<template>
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div v-if="inBasketAlready" class="mt-4 text-muted warning">Seems like you've added this object tobasket already.if you want to change dates, remove from the basket first</div>
        </div>
    </div>
</template>
