<template>
    <div>
        <success v-if="success">Congratulations</success>
        <div class="row" v-else>
            <div class="col-md-8" v-if="itemsInBasket">
                ...
                <div class="form-row">
                    <div class="col-md-12 form-group">
                        <button type="submit" class="btn btn-block btn-primary btn-lg" @click.prevent="book" :disabled="loading">Book Now!</button>
                    </div>
                </div>
            </div>
                ...
                <transition-group name="fade">
                    <div v-for="item in basket" :key="item.bookable.id">
                        <div class="pt-2 pb-2 border-top d-flex justify-content-between">
                            ...
                            <span class="font-weight-border">${{ item.price.total }}</span>
                        </div>
